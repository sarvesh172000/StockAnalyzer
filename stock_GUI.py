...
class StockGUI:
    def __init__(self, root):
        ...
        # Title
        ttk.Label(self.main_frame, text="Stock Analyzer", font=("Arial", 16, "bold")).pack(pady=10)
    ...
    def save_to_database(self):
        stock_db.export_to_csv(self.stock_list, is_gui=True, root=self.root)
    ...
    def load_from_database(self):
        ...
        output, success = stock_db.load_from_csv(filename, self.stock_list, symbol, dateFrom, dateTo, is_gui=True)
        if success:
            self.display_output(output)
